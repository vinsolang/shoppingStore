          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item">
                  <a href="{{route('logo.add')}}" class="menu-link">
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="{{route('news.view')}}" class="menu-link">
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="/admin/log-activity" class="menu-link">
                    <div data-i18n="Without menu">View log-activity</div>
                  </a>
                </li>
              </ul>
            </li>
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                      <img src="../../assets/image/{{Auth::User()->profile}}" alt class="w-px-40 h-auto rounded-circle" />
                    </div>
                  </a>
